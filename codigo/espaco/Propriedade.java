...
public abstract class Propriedade extends Espaco 
{
    ...
    protected int preco;
    protected boolean casaConstruida;
    ...
    public boolean getCasaConstruida()
    {
        return(this.casaConstruida);
    }

    public void setCasaConstruida(boolean construido)
    {
        this.casaConstruida = construido;
    }
